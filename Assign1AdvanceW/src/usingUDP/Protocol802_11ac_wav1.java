...
public class Protocol802_11ac_wav1 {
	...
	static int MACHEADERf = 40;//11n/ac MAC header = 40 bytes
	 ...
	 *         DIFSt+Preamblet+RTSt+SIFSt+Preamblet+CTSt+SIFSt+Preamblet+DATAt+SIFSt+Preamblet+ACKt
	...
	public static int DATAbit() {                   // Data bits per OFDM symbol
		BlockSizeAC1 bs = new BlockSizeAC1();
...
//96.3, 86.7, 72.2, 65, 57.8, 43.3, 28.9, 21.7, 14.4, 7.2 
class BlockSizeAC1 {								// Encoding Block Sizes for 802.11a
